...
O projeto deste DataFrame foi desenvolvido utilizando a biblioteca Pandas para formar um DataFrame com listas e um dicionário como base, sendo estes em cada questões sendo utilizados os comando referentes as perguntas tendo estes comando derivados da própria biblioteca Pandas. O tema deste DataFrame foi baseado em streamings de música como Spotify, Amazon Music, Deezer, etc. Foram criadas listas com o nome de músicas especificas, seus respectivos autores, gêneros musicais e tempo em minutos e a partir dessas listas, foi criado um diciónario que serviu como base para o DataFrame guardando os respectivos dados das listas. Foram encontrados desafios como representação prática dos dados e comandos utilizados sendo necessária pesquisa e testes práticos.
"""